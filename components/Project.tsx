    ...
    >
      <section className="bg-gray-100 max-w-[42rem] border-2 border-gray-200 rounded-lg overflow-hidden sm:pr-8 relative sm:h-[20rem] hover:bg-gray-200 transition sm:group-even:pl-11 dark:text-white dark:bg-white/10 dark:hover:bg-white/20">
        ...
        <Image
          ...
          width={400}
          height={400}
          className="w-96 absolute hidden sm:block top-8 -right-24  rounded-t-lg shadow-2xl transition group-hover:scale-[1.04] group-hover:-translate-x-3 group-hover:translate-y-3 group-hover:-rotate-2 group-even:group-hover:translate-x-3 group-even:group-hover:translate-y-3 group-even:group-hover:rotate-2 group-even:right-[initial] group-even:-left-24"
        />
      </section>
    </motion.div>
  );
