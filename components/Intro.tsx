	...
	return (
		...
		>
				...
				<div className="relative">
					...
					>
						<Image
							...
							priority={true}
							quality={95}
							className="w-48 h-48 rounded-full object-cover border-[0.35rem] border-white shadow-xl"
						/>
					</motion.div>
					<motion.span
			...
			>
				...
				corporis, adipisci fugiat vitae totam, incidunt atque sed veritatis
				harum aut nostrum suscipit doloribus omnis odit reiciendis.
			</motion.h1>
